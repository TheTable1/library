...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "e54da086-0232-4e7c-b400-a7190659ce43",
...
const _0POZPtfbfmGXheTsAQDQb_CfVjUH2iNozmvOgQRuxw = (function(nitro) {
...
const plugins = [
  _0POZPtfbfmGXheTsAQDQb_CfVjUH2iNozmvOgQRuxw
];
...
const _DW1PHQ = defineCachedEventHandler(async (event) => {
...
const _lazy_kdDEHF = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_kdDEHF, lazy: true, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _DW1PHQ, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_kdDEHF, lazy: true, middleware: false, method: undefined }
];
...
export { $fetch$1 as $, defu as A, serialize$1 as B, isEqual as C, parseQuery as D, withTrailingSlash as E, withoutTrailingSlash as F, useRuntimeConfig as a, buildAssetsURL as b, getResponseStatusText as c, getResponseStatus as d, defineRenderHandler as e, getQuery as f, getRouteRulesForPath as g, createError$1 as h, getRouteRules as i, joinHeaders as j, defuFn as k, klona as l, hasProtocol as m, normalizeCookieHeader as n, isScriptProtocol as o, publicAssetsURL as p, joinURL as q, getContext as r, sanitizeStatusCode as s, baseURL as t, useNitroApp as u, createHooks as v, withQuery as w, executeAsync as x, toRouteMatcher as y, createRouter$1 as z };
