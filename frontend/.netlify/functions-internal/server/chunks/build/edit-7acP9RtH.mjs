...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="flex justify-end"><button type="submit"${ssrIncludeBooleanAttr(loading.value) ? " disabled" : ""} class="flex items-center gap-2 bg-darkblue text-white font-semibold px-6 py-2 rounded-lg hover:bg-blue-800 transition disabled:opacity-50">`);
      _push(ssrRenderComponent(_component_UIcon, {
        name: "i-lucide-save",
        class: "text-lg"
      }, null, _parent));
      ...
      if (showSuccess.value) {
        ...
        _push(`<h2 class="text-xl font-semibold text-gray-800">Loan updated successfully!</h2><button class="mt-4 bg-green-600 text-white font-medium px-6 py-2 rounded-lg hover:bg-green-700 transition"> OK </button></div></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</main></div>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/lists/[id]/edit.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=edit-7acP9RtH.mjs.map
