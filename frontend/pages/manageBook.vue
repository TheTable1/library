          ...
          <div v-else class="overflow-x-auto">
            <table class=" w-full divide-y divide-gray-200">
              <thead class="bg-gray-50">
                <tr>
                  <th class="px-1 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">No.</th>
                  ...
                  <th class="px-3 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Available
                  </th>
              ...
              <tbody class="bg-white divide-y divide-gray-200">
                <tr v-for="(book, i) in books" :key="book.id">
                  <td class="px-1 py-2 text-sm text-gray-900">{{ i + 1 }}</td>
                  ...
                  <td class="px-3 py-2 text-sm font-medium">
                    <div class="flex space-x-2">
                      <UButton variant="ghost" size="sm" icon="i-lucide-eye" @click="viewBook(book)" />
                      <UButton variant="ghost" size="sm" icon="i-lucide-edit" @click="ed(book)" />
                      <UButton variant="ghost" size="sm" icon="i-lucide-trash" @click="deleteBook(book)" />
                    </div>
                  </td>
                </tr>
              </tbody>
