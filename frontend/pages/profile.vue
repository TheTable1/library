                            ...
                            <div class="flex lg:flex-row items-center lg:items-start space-y-6 lg:space-y-0 lg:space-x-8">
                                ...
                                <div class="flex-1 text-center lg:text-left">
                                    ...
                                    <div class="flex flex-col sm:flex-row items-center justify-center lg:justify-start space-y-3 sm:space-y-0 sm:space-x-6">
                                        ...
                                        <span class="text-white/80 text-sm font-medium bg-white/10 px-4 py-2 rounded-full backdrop-blur-sm mb-2">
                                            User ID : {{ user.id }}
                                        </span>
                                ...
                                <div>
                                    <router-link :to="`/users/users-list/${user.id}`" class="px-3 py-2 bg-white/50 rounded-xl text-sm font-medium text-slate-800 hover:bg-white/70 cp">List Detail</router-link>
                                </div>
                            </div>
                        </div>
                    </div>
