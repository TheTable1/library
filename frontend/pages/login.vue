<template>
  <div class="min-h-screen flex items-center justify-center bg-cover bg-center relative"
    ...
    <div class="relative bg-white backdrop-blur-sm rounded-xl shadow-2xl p-10 max-w-md w-full">
      <!-- Back Button -->
      <button @click="goBack" class="absolute top-4 right-4 p-2 rounded-full hover:bg-gray-100 transition cp"
        aria-label="Go Back">
      ...
      <form @submit.prevent="onSubmit" class="space-y-6">
        ...
        <p class="text-gray-400 mt-3">
          ...
          <router-link to="/register" class="text-darkblue font-bold ">
            Register
          </router-link>
        </p>
