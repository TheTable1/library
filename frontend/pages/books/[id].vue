  ...
  <div class="flex min-h-screen bg-gradient-to-br from-gray-50 to-blue-50">
    ...
    <main class="flex-1 p-6 pt-3">
      ...
      <div v-if="loading" class="flex items-center justify-center h-full">
        <div class="flex flex-col items-center space-y-4 text-gray-600">
          <div class="relative">
            ...
            />
            <div
              class="absolute inset-0 bg-blue-100 rounded-full animate-pulse opacity-30"
            ></div>
          </div>
      ...
      <div v-else-if="error" class="max-w-2xl mx-auto">
        <div
          class="bg-gradient-to-r from-red-50 to-pink-50 border border-red-200 rounded-xl p-6 shadow-lg"
        >
      ...
      <div v-else-if="book" class="max-w-6xl mx-auto pt-3">
        ...
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
          ...
          <div class="lg:flex a">
            <!-- Book Image Section -->
            <div
              class="lg:w-2/5 bg-gradient-to-br from-gray-50 to-blue-50 flex items-start justify-center p-8 lg:pt-15"
            >
              <div class="relative group">
                ...
                <div class="absolute -top-3 -right-3">
                  <div
                    ...
                    "
                    class="px-3 py-1 rounded-full text-sm font-semibold shadow-lg"
                  >
                    {{
            ...
            <div class="lg:w-3/5 p-8">
              <div class="space-y-6">
                  ...
                  <div class="flex">
                    <button
                      ...
                      :class="[
                        ...
                        isFavorited ? 'bg-red-500' : 'bg-gray-400',
                      ]"
                    >
                      <UIcon
                        :name="
                          isFavorited ? 'i-lucide-heart-off' : 'i-lucide-heart'
                        "
                        class="text-lg"
                      />
                ...
                <!-- Categories Section -->
                <div
                  class="md:flex bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl py-3 px-5"
                >
...
const currentFavId = computed(() => {
  const fav = favorites.value.find((fav) => fav.bookId === bookId);
...
async function toggleFavorite() {
  try {
    ...
    } else if (currentFavId.value) {
      await $fetch(`/favorite/${currentFavId.value}`, {
        method: "DELETE",
        baseURL: "http://localhost:3000",
        headers: { Authorization: `Bearer ${getToken()}` },
      });
...
onMounted(async () => {
  await Promise.all([fetchBook(), fetchFavorites()]);
});
</script>
